...
Bot ID : @tmshop_bot
Dev ID : @dj_kt110
GitAdress : https://github.com/Alikt110/Tehran-Markaz-Antispambot
─═ঊঈঊঈ═─╯
*/
...
elseif($textmassage=="بخش مدیریت گروه" && $tc == "private"){
    ...
    'parse_mode'=>'MarkDown',
			...
			save("data/$from_id/file.txt","none");
				MrPHPBot('sendmessage',[
		'chat_id'=>$chat_id,
		'text'=>" ربات در سال 1396 ساخته شد و  امیدوارهستیم که کاربران از این ربات به خوبی حمایت کنند\nمناسب برای مدیریت گروه و کانال.\nبرنامه نویس : DJ KT\nزبان برنامه نویسی : php\nارتباط با ما : \n@tehranmarkazshop\n@dj_kt110\n@tmshop_bot",
    'parse_mode'=>'MarkDown',
		]);
